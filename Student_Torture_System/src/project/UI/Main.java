...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		System.out.println();
		System.out.println("Welcome to Automated Student Torture system!");
...
//				int opt;
			...
			else System.out.println("Please enter correct ID and Password! BDSK");
		...
		else System.out.println("Please enter valid input 1, 2 or 3 BDSK");
		
		}
		catch(InputMismatchException ime) {
			System.out.println("Please enter valid input BDSK");
		}
